class FilmsController < ApplicationController
  ...
  private
    ...
    def film_params
      params.require(:film).permit(:title, :description, :release_year, :language_id, :rental_duration, :rental_rate, :length, :replacement_cost, :rating, :last_update, :special_features, :fulltext)
    end
end
