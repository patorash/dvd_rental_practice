...
class LanguagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create language" do
    assert_difference('Language.count') do
      post languages_url, params: { language: { last_update: @language.last_update, name: @language.name } }
    end
  ...
  test "should update language" do
    patch language_url(@language), params: { language: { last_update: @language.last_update, name: @language.name } }
